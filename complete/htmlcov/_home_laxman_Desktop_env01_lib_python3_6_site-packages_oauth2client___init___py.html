...
<head>
    ...
    <title>Coverage for /home/laxman/Desktop/env01/lib/python3.6/site-packages/oauth2client/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/laxman/Desktop/env01/lib/python3.6/site-packages/oauth2client/__init__.py</b> :
...
<p id="t15" class="stm run hide_run"><span class="str">"""Client library for using OAuth2, especially with Google APIs."""</span><span class="strut">&nbsp;</span></p>
<p id="t16" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t17" class="stm run hide_run"><span class="nam">__version__</span> <span class="op">=</span> <span class="str">'4.1.3'</span><span class="strut">&nbsp;</span></p>
<p id="t18" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t19" class="stm run hide_run"><span class="nam">GOOGLE_AUTH_URI</span> <span class="op">=</span> <span class="str">'https://accounts.google.com/o/oauth2/v2/auth'</span><span class="strut">&nbsp;</span></p>
<p id="t20" class="stm run hide_run"><span class="nam">GOOGLE_DEVICE_URI</span> <span class="op">=</span> <span class="str">'https://oauth2.googleapis.com/device/code'</span><span class="strut">&nbsp;</span></p>
<p id="t21" class="stm run hide_run"><span class="nam">GOOGLE_REVOKE_URI</span> <span class="op">=</span> <span class="str">'https://oauth2.googleapis.com/revoke'</span><span class="strut">&nbsp;</span></p>
<p id="t22" class="stm run hide_run"><span class="nam">GOOGLE_TOKEN_URI</span> <span class="op">=</span> <span class="str">'https://oauth2.googleapis.com/token'</span><span class="strut">&nbsp;</span></p>
<p id="t23" class="stm run hide_run"><span class="nam">GOOGLE_TOKEN_INFO_URI</span> <span class="op">=</span> <span class="str">'https://oauth2.googleapis.com/tokeninfo'</span><span class="strut">&nbsp;</span></p>
