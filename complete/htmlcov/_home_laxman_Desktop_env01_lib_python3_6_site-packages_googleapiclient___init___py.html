...
<head>
    ...
    <title>Coverage for /home/laxman/Desktop/env01/lib/python3.6/site-packages/googleapiclient/__init__.py: 56%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/laxman/Desktop/env01/lib/python3.6/site-packages/googleapiclient/__init__.py</b> :
...
<p id="t15" class="stm run hide_run"><span class="nam">__version__</span> <span class="op">=</span> <span class="str">"1.7.5"</span><span class="strut">&nbsp;</span></p>
<p id="t16" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t17" class="pln"><span class="com"># Set default logging handler to avoid "No handler found" warnings.</span><span class="strut">&nbsp;</span></p>
...
<p id="t20" class="stm run hide_run"><span class="key">try</span><span class="op">:</span>  <span class="com"># Python 2.7+</span><span class="strut">&nbsp;</span></p>
...
<p id="t23" class="stm mis">    <span class="key">class</span> <span class="nam">NullHandler</span><span class="op">(</span><span class="nam">logging</span><span class="op">.</span><span class="nam">Handler</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t24" class="stm mis">        <span class="key">def</span> <span class="nam">emit</span><span class="op">(</span><span class="nam">self</span><span class="op">,</span> <span class="nam">record</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t25" class="stm mis">            <span class="key">pass</span><span class="strut">&nbsp;</span></p>
<p id="t26" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t27" class="stm run hide_run"><span class="nam">logging</span><span class="op">.</span><span class="nam">getLogger</span><span class="op">(</span><span class="nam">__name__</span><span class="op">)</span><span class="op">.</span><span class="nam">addHandler</span><span class="op">(</span><span class="nam">NullHandler</span><span class="op">(</span><span class="op">)</span><span class="op">)</span><span class="strut">&nbsp;</span></p>
