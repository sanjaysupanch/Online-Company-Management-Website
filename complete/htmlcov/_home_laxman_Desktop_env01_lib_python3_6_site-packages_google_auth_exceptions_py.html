...
<head>
    ...
    <title>Coverage for /home/laxman/Desktop/env01/lib/python3.6/site-packages/google/auth/exceptions.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/laxman/Desktop/env01/lib/python3.6/site-packages/google/auth/exceptions.py</b> :
...
<p id="t15" class="stm run hide_run"><span class="str">"""Exceptions used in the google.auth package."""</span><span class="strut">&nbsp;</span></p>
<p id="t16" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t17" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t18" class="stm run hide_run"><span class="key">class</span> <span class="nam">GoogleAuthError</span><span class="op">(</span><span class="nam">Exception</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t19" class="pln">    <span class="str">"""Base class for all google.auth errors."""</span><span class="strut">&nbsp;</span></p>
<p id="t20" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t21" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t22" class="stm run hide_run"><span class="key">class</span> <span class="nam">TransportError</span><span class="op">(</span><span class="nam">GoogleAuthError</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t23" class="pln">    <span class="str">"""Used to indicate an error occurred during an HTTP request."""</span><span class="strut">&nbsp;</span></p>
<p id="t24" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t25" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t26" class="stm run hide_run"><span class="key">class</span> <span class="nam">RefreshError</span><span class="op">(</span><span class="nam">GoogleAuthError</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t27" class="pln">    <span class="str">"""Used to indicate that an refreshing the credentials' access token</span><span class="strut">&nbsp;</span></p>
<p id="t28" class="pln"><span class="str">    failed."""</span><span class="strut">&nbsp;</span></p>
<p id="t29" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t30" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t31" class="stm run hide_run"><span class="key">class</span> <span class="nam">DefaultCredentialsError</span><span class="op">(</span><span class="nam">GoogleAuthError</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t32" class="pln">    <span class="str">"""Used to indicate that acquiring default credentials failed."""</span><span class="strut">&nbsp;</span></p>
